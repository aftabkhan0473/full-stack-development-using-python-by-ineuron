...
# 8. Write a python script to print the value of a variable. Variable containsyour name as data.
your_name = "MD AFTAB ALI"
print(your_name)

# 9. Write a python script to create variables to store your name, age, qualification, years of experience and print it.

name, age, qualification, years_of_experience = "Md Aftab Ali", 20, "Full stack Development", 0;
